...
class AmphSettings(QSettings):
    ...
    def __init__(self, *args):
        super(AmphSettings, self).__init__(
            QSettings.IniFormat, QSettings.UserScope, "Amphetype", "Amphetype"
        )
...
class SettingsEdit(AmphEdit):
    def __init__(self, setting):
        ...
        self.connect(
            Settings, SIGNAL("change_" + setting), lambda x: self.setText(self.fmt(x))
        )
            ...
            AmphBoxLayout(
                [
                    [
                        "Typer font is",
                        self.font_lbl,
                        AmphButton("Change...", self.setFont),
                        None,
                    ],
                    [
                        SettingsCheckBox(
                    ...
                    SettingsCheckBox(
                        "show_last", "Show last result(s) above text in the Typer."
                    ),
                    SettingsCheckBox(
                        "use_lesson_stats",
                    ...
                    [
                        SettingsCheckBox(
                            "req_space", "Make SPACE mandatory before each session"
                        ),
                        (
                            '<a href="http://code.google.com/p/amphetype/wiki/Settings">(help)</a>\n',
                            1,
